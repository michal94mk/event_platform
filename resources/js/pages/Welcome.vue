            ...
            <main>
                ...
                <section class="border-y border-[#19140035] bg-white dark:border-[#3E3E3A] dark:bg-[#161615]">
                    <div class="mx-auto max-w-6xl px-4 py-16 md:py-20">
                        <h2 class="text-center text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Jak to działa</h2>
                ...
                <section class="mx-auto max-w-6xl px-4 py-16 md:py-20">
                    <div class="flex items-center justify-between">
                        <h2 class="text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Najbliższe wydarzenia</h2>
                        <Link :href="route('events.index')" class="text-sm font-medium text-primary hover:underline"> Zobacz wszystkie → </Link>
                    </div>
                    ...
                    >
                        ...
                        <Link v-else :href="route('register')" class="mt-4 inline-block text-sm font-medium text-primary hover:underline">
                        ...
                        >
                            <Link :href="route('events.show', event.slug)" class="block">
                                <div class="relative h-40 bg-[#1914000a] dark:bg-[#3E3E3A]">
                                    ...
                                    />
                                    <div v-else class="flex h-full w-full items-center justify-center text-[#706f6c] dark:text-[#A1A09A]">
                ...
                >
                    <div class="mx-auto max-w-6xl px-4 py-16 md:py-20">
                        <div class="mx-auto max-w-2xl text-center">
                            <h2 class="text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Organizujesz wydarzenia?</h2>
